...
fn read_rows_response_to_record_batch(response: ReadRowsResponse, schema: &Vec<u8>) -> DataFrame {
    ...
    // EOS indicator is the 4-byte continuation indicator (0xFFFFFFFF) followed by 0 metadata
    // length (0x00000000). See:
    // https://arrow.apache.org/docs/format/Columnar.html#ipc-streaming-format
    let mut eos: Vec<u8> = vec![0xff, 0xff, 0xff, 0xff, 0, 0, 0, 0];
    buffer.append(&mut eos);

    // Footer: https://github.com/apache/arrow/blob/a7c0b41dc998d3f8e06a1c711607e00b7bf55fa8/format/File.fbs#L27
    // Flatbuffer: https://github.com/dvidelabs/flatcc/blob/master/doc/binary-format.md#flatbuffers-binary-format
    // See: https://github.com/apache/arrow/blob/a7c0b41dc998d3f8e06a1c711607e00b7bf55fa8/format/Schema.fbs#L44-L51 and 
    let mut footer_version: Vec<u8> = vec![0x04, 0x00 ];
    buffer.append(&mut footer_version);
